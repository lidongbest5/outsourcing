...
class MBApiClient
{
    ...
    function __construct( $wbakey , $wbskey , $host, $format, $accecss_token , $accecss_token_secret ) 
	{
		$this->format = $format;
        $this->oauth = new MBOpenTOAuth( $wbakey , $wbskey , $host, $format, $accecss_token , $accecss_token_secret ); 
	}
