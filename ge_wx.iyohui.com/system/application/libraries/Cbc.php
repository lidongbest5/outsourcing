...
// +----------------------------------------------------------------------+
//
// $Id: CBC.php,v 1.3 2002/05/10 16:30:25 cmv Exp $
//

require_once dirname(__FILE__).'/3rd/Pear.class.php';
...
class MY_Cbc extends PEAR {
    ...
    * BLOWFISH-COMPAT
    *
    * @param    $param['Key']	        encryption key
    * @param    $param['Cipher']	    which algorithm to use, defaults to DES
    *
