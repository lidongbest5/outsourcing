...
* (3) $object->fetcharray() - returns query results as an array结果是一维数组
...
* (6) $object->showDataAsTable() - outputs results as html tables直接执行sql语句，结果是二维数组形式
