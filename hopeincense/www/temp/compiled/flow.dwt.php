              ...
              <td bgcolor="#ffffff" align="center">
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                  ...
                  <?php elseif ($this->_var['show_goods_thumb'] == 2): ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" onload="mSize(this,120,130);"/></a>
                  <?php else: ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"onload="mSize(this,120,130);" /></a><br />
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a>
                  <?php endif; ?>
...
?>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff" align="right"><a href="./"><img src="themes/default/images/continue.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="left"><a href="flow.php?step=checkout"><img src="themes/default/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?>
            <tr>
              ...
              <td bgcolor="#ffffff" align="left" valign="top"><?php echo $this->_var['shipping']['format_shipping_fee']; ?></td>
              <td bgcolor="#ffffff" align="left" valign="top"><?php echo $this->_var['shipping']['free_money']; ?></td>
              <td bgcolor="#ffffff" align="left" valign="top"><?php if ($this->_var['shipping']['insure'] != 0): ?><?php echo $this->_var['shipping']['insure_formated']; ?><?php else: ?><?php echo $this->_var['lang']['not_support_insure']; ?><?php endif; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <tr>
              <td colspan="6" bgcolor="#ffffff" align="left"><label for="ECS_NEEDINSURE">
...
?>
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff" valign="top"><?php echo $this->_var['payment']['format_pay_fee']; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
    </div>
...
?>
            <tr>
              ...
              <td valign="top" bgcolor="#ffffff" align="center"><?php echo $this->_var['pack']['format_pack_fee']; ?></td>
              <td valign="top" bgcolor="#ffffff" align="center"><?php echo $this->_var['pack']['format_free_money']; ?></td>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            ...
            <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
                <table width="90%" border="0" cellpadding="8" cellspacing="1" bgcolor="#DED6CE" class="table">
                  <tr>
                    <td bgcolor="#ffffff"><div align="center"><strong><?php echo $this->_var['lang']['username']; ?></strong></div></td>
                    <td bgcolor="#ffffff"><input name="username" type="text" class="inputBg" id="username" /></td>
                  </tr>
                  <tr>
                    <td bgcolor="#ffffff"><div align="center"><strong><?php echo $this->_var['lang']['password']; ?></strong></div></td>
                    <td bgcolor="#ffffff"><input name="password" class="inputBg" type="password" /></td>
                  </tr>
                  <?php if ($this->_var['enabled_login_captcha']): ?>
                  <tr>
                    <td bgcolor="#ffffff"><div align="center"><strong><?php echo $this->_var['lang']['comment_captcha']; ?>:</strong></div></td>
                  ...
                  <?php endif; ?>
                  <tr>
            <td colspan="2"  bgcolor="#ffffff"  style="padding-left:90px;"><input type="checkbox" value="1" name="remember" id="remember" /><label for="remember"><?php echo $this->_var['lang']['remember']; ?></label></td>
          </tr>
                  <tr>
            ...
            <form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
               <table width="98%" border="0" cellpadding="8" cellspacing="1" bgcolor="#DED6CE" class="table">
                  <tr>
                    <td bgcolor="#ffffff" align="center" width="25%"><strong><?php echo $this->_var['lang']['username']; ?></strong></td>
            ...
            <span id="username_notice" style="color:#FF0000"></span></td>
                  ...
                  <tr>
                    <td bgcolor="#ffffff" align="center"><strong><?php echo $this->_var['lang']['email_address']; ?></strong></td>
            ...
            <span id="email_notice" style="color:#FF0000"></span></td>
                  ...
                  <tr>
                    <td bgcolor="#ffffff" align="center"><strong><?php echo $this->_var['lang']['password']; ?></strong></td>
            ...
            <span style="color:#FF0000" id="password_notice"></span></td>
                  ...
                  <tr>
                    <td bgcolor="#ffffff" align="center"><strong><?php echo $this->_var['lang']['confirm_password']; ?></strong></td>
            ...
            <span style="color:#FF0000" id="conform_password_notice"></span></td>
                  ...
                  <tr>
                    <td bgcolor="#ffffff" align="center"><strong><?php echo $this->_var['lang']['comment_captcha']; ?>:</strong></td>
                    <td bgcolor="#ffffff"><input type="text" size="8" name="captcha" class="inputBg" />
