<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:76:"/Users/dongli/Documents/Outsourcing/hopeincense/www/themes/default/goods.dwt";i:1;s:90:"/Users/dongli/Documents/Outsourcing/hopeincense/www/themes/default/library/page_header.lbi";i:2;s:90:"/Users/dongli/Documents/Outsourcing/hopeincense/www/themes/default/library/page_footer.lbi";}s:7:"expires";i:1420302783;s:8:"maketime";i:1420299183;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>极品天然檀香__HOPE INCENSE</title>
...
<script type="text/javascript" src="js/common2.js"></script><script type="text/javascript" src="js/json2.js"></script><script type="text/javascript" src="js/transport2.js"></script>
<base target="_blank"/>
</head>
<body>
<script type="text/javascript">
...
<a href=""><img alt="prev" src="themes/default/images/up.gif" /></a>
...
<div class="wind978">
  <div class="left viewpic">
    ...
    <a href="images/201310/source_img/20_P_1382014083192.JPG" id="mainImg" class="jqzoom" target="_blank">
		<img src="images/201310/goods_img/20_P_1382014083911.JPG" id="mainPicture"  class="goodsimg" />
    </a>
               </div>
	<div class="sp2">
        <ul id="Tab1">
             ...
             <li><a class="current" href="javascript:void(0)" target="_self" onclick="showImg(2);">2</a></li>
                                     <input type="hidden" id=img_original_2 value="images/201310/source_img/20_P_1382014083192.JPG"/>
        <input type="hidden" id=img_goods_2 value="images/201310/goods_img/20_P_1382014083911.JPG"/>
  ...
  <div class="viewcontent right">
        ...
        <form action="javascript:addToCart(20)" target="_self" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          <ul class="tb-meta">
          <li><h3></h3></li>
                    <li><span>货　　号：</span>CX000020</li>
          <li><span>价　　格：</span><strong class="tb-price">￥580元</strong></li>
          <li><span>详细介绍：</span><p class="clear"></p></li>
          <li><div class="goods-desc"><p><strong>极品天然檀香<br />
</strong>香品规格：220支/盒&nbsp;&nbsp; 长度：28CM&nbsp;&nbsp; 20盒/箱<br />
香品重量：720g(含外包装)<br />
燃烧时间：约80分钟<br />
主要成份：天然檀香粉 植物粘粉<br />
香料功能：净化空气，改善环境<br />
香品烟型：微烟<br />
适用范围：家居日用 香道</p></div></li>
         </ul>
           <div class="tb-key">
            ...
            <dt>类型：</dt>
            <dd>
            <ul class="tb-clearfix" data-property="类型" id="tab3">
            
                                    <li class="tb-selected" >
            <a title="线形" href="javascript:void(0);" target="_self" onclick="changeProperty(3,0,24)"><span>线形</span></a>
             <i >已选中</i>
            <input type="hidden" name="spec_3" value="24" id="spec_value_3" />            </li>
            ...
            <dl class="tb-prop tb-clearfix">
                <dt>我 要 买：</dt>
                <dd>
                <input name="number" type="text" id="number" value="1" size="4"  class="tb-text" title="请输入购买量" maxlength="8" />                <em>(库存<span class="tb-count">100</span>)</em>
               </dd>
            </dl>
			...
			<div style="margin-top:15px;">
            <div class="addtocart">
            <a href="javascript:addToCart(20)" target="_self"><img src="themes/default/images/button.jpg" /></a></div>
		...
		<div class="right viewright">
			...
			<div class="viewpic">
				<ul>
                                  <li><a href="goods.php?id=9"><img src="images/201310/thumb_img/9_thumb_G_1382070837857.JPG" alt="极品八百年沉香" width="100" height="106"  onload="mSize(this,100,106);"/></a></li>
                                   <li><a href="goods.php?id=13"><img src="images/201310/thumb_img/13_thumb_G_1382274973151.JPG" alt="印度老山檀香" width="100" height="106"  onload="mSize(this,100,106);"/></a></li>
                  				</ul>
			</div>
		</div>
	</div>
...
<script src="themes/default/js/index.js"></script><script>
//选择商品属性
