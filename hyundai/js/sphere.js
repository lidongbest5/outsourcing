(function () {
	...
	function onPointerDown( area, response ) {
		if ( area.onTouchStart || area.onCursorDown ) {
			...
			return bind( "touchstart", "touchmove", "touchend" );
		}
	}
	...
	// endregion
	sphereRadius = document.querySelectorAll( ".main" ).offsetHeight * 0.1969;
	...
	function CommentWall( parent, commentData ) {
		var fragmentSize = 25 / 504 * document.querySelectorAll( ".main" ).offsetHeight, // 碎片的尺寸
