function Lottery(id, cover, coverType, width, height,drawPercentCallback) {
    ...
    this.deltaTop   =   window.win_width*200/320;
    this.deltaLeft  =   (window.win_width-254)/2;
}
...
Lottery.prototype = {
    ...
    bindEvent: function () {
        ...
        if (e) t.conNode.addEventListener("touchmove", function (t) {
            ...
            e >= 10 && "function" == typeof t.drawPercentCallback && t.drawPercentCallback()
        }, !1);
        else {
            var a = !1;
            t.conNode.addEventListener("mouseup", function (e) {
                ...
                n >= 10 && "function" == typeof t.drawPercentCallback && t.drawPercentCallback()
            }, !1)
        }
